public class Test {
    ...
    public static boolean vec_rep() {
        ...
        return v.toString().equals("{1, 2, 3, 4, 5}");
    }

    static boolean vec_dot() {
        double[] e1 = {1, 2, 3};
        double[] e2 = {4, 5, 6};
        ...
        return v1.dotProduct(v2) == 32.0;
    }

    static boolean vec_set() {
        double[] e = {2, 4, 6, 8, 10};
